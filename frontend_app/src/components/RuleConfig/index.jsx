  ...
  return (
    <section className="op-section" aria-labelledby="rules-title" aria-describedby="rules-desc" data-tour-id="rules">
      ...
      <div className="op-card" style={{ display: 'grid', gap: 16 }}>
        <div>
          <div style={{ fontWeight: 700, marginBottom: 8 }}>Grouping & Time</div>
        ...
        <div>
          <div style={{ fontWeight: 700, marginBottom: 8 }}>Inclusions</div>
          ...
          {/* place for inline validation messages in future */}
          <div className="op-status" aria-live="polite" style={{ marginTop: 6 }} />
        </div>
      </div>
    </section>
  );
